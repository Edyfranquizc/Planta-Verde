    ...
    return (
        ...
        <div className="nosotros-historia">
            ...
            <div className="nosotros-contenido">
                ...
                <img src="/assets/Ficus-Lyrata.png" alt="Equipo PlantaVerde" />
                </div>
        ...
        <div className="seccion-equipo">
            ...
            <div className="equipo-grid">
                ...
                <div className="imagen-miembro">
                    <img src="/assets/avatar-patricia.png" alt="Miembro del equipo" />
                </div>
                ...
                <div className="miembro-equipo">
                <div className="imagen-miembro">
                    <img src="/assets/avatar-gabriela.png" alt="Miembro del equipo" />
                </div>
                ...
                <div className="miembro-equipo">
                <div className="imagen-miembro">
                    <img src="/assets/avatar-fabian.png" alt="Miembro del equipo" />
                </div>
