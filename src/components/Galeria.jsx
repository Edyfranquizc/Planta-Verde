    ...
    return (
        ...
        <div className="container">
            ...
            <div className="categoria-card grande">
                ...
                <img src="/src/assets/calathea-orbifolia.png" alt="Plantas de Interior" />
                </div>
            ...
            <div className="categoria-card">
                <div className="categoria-imagen">
                <img src="/src/assets/salvia.png" alt="Plantas de Exterior" />
                </div>
                <div className="categoria-info">
            ...
            <div className="categoria-card">
                <div className="categoria-imagen">
                <img src="/src/assets/suculenta-echeveria.png" alt="Suculentas" />
                </div>
                <div className="categoria-info">
                <h3>Suculentas</h3>
            ...
            <div className="categoria-card">
                <div className="categoria-imagen">
                <img src="../assets/lavanda.png" alt="Aromáticas" />
                </div>
                <div className="categoria-info">
                <h3>Aromáticas</h3>
